...
<body class="bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 min-h-screen flex items-center justify-center">
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="bg-white rounded-lg shadow-2xl p-12 mb-8">
            ...
            <!-- CTA Buttons -->
            <div class="space-y-4">
                <a href="<?php echo e(route('login')); ?>" class="block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg text-center transition duration-200 text-lg">
                    ✉️ Sign In
                </a>

                <a href="<?php echo e(route('member.register')); ?>" class="block w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg text-center transition duration-200 text-lg">
                    🚀 Create Account
                </a>
            </div>
...
<?php /**PATH C:\Users\lenovo\Desktop\K2\K2_App\resources\views/landing.blade.php ENDPATH**/ ?>