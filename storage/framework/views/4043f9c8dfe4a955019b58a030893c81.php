    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative" x-data="{ open: false }">
            ...
            <div x-show="open" @click.outside="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow z-50 border">
                ...
                <a href="<?php echo e(route('home')); ?>" class="block px-4 py-2 hover:bg-gray-100">Back to Site</a>
...
<?php /**PATH C:\Users\lenovo\Desktop\K2\K2_App\resources\views/admin/partials/navbar.blade.php ENDPATH**/ ?>