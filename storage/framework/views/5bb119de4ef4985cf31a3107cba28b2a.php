...
<div class="container mx-auto px-4 py-8">
    <!-- Welcome Section -->
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 mb-2">Welcome, <?php echo e($user->first_name); ?>! 👋</h1>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="border-l-4 border-blue-600 pl-4">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e(ucfirst($user->membership_tier)); ?></p>
                <p class="text-xs text-gray-600">
                    <?php if($stats['active_membership']): ?>
                        ✓ Active until <?php echo e($stats['membership_expires_at']->format('M d, Y')); ?>
            ...
            <div class="border-l-4 border-green-600 pl-4">
                ...
                <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($stats['total_orders']); ?></p>
                <a href="<?php echo e(route('orders.index')); ?>" class="text-xs text-green-600 hover:text-green-700 font-semibold">View Orders →</a>
            </div>

            <!-- Cart -->
            <div class="border-l-4 border-purple-600 pl-4">
                <p class="text-sm text-gray-600 mb-1">Shopping Cart</p>
                <p class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($stats['total_cart_items']); ?></p>
                <a href="<?php echo e(route('cart.index')); ?>" class="text-xs text-purple-600 hover:text-purple-700 font-semibold">View Cart →</a>
            </div>
        </div>
    </div>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Marketplace -->
            <a href="<?php echo e(route('marketplace.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
            ...
            <!-- Events -->
            <a href="<?php echo e(route('events.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
                <div class="text-5xl mb-4">🎯</div>
            ...
            <!-- Expeditions -->
            <a href="<?php echo e(route('expeditions.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
                <div class="text-5xl mb-4">🗻</div>
            ...
            <!-- Community -->
            <a href="<?php echo e(route('community.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
                <div class="text-5xl mb-4">👥</div>
            ...
            <!-- Vendors -->
            <a href="<?php echo e(route('vendors.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
                <div class="text-5xl mb-4">🏢</div>
            ...
            <!-- Profile -->
            <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition transform p-6">
                <div class="text-5xl mb-4">👤</div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-8 mb-8">
        <h2 class="text-2xl font-bold text-gray-900 mb-6">Your <?php echo e(ucfirst($user->membership_tier)); ?> Membership Includes</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <?php if(strtolower($user->membership_tier) === 'premium'): ?>
            <div class="flex items-center">
                <span class="text-2xl mr-3">✓</span>
    ...
    <div class="bg-orange-50 border-l-4 border-orange-500 p-6 rounded-lg">
        ...
        <a href="<?php echo e(route('profile.membership')); ?>" class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded-lg">
            Renew Membership
        </a>
    </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\K2\K2_App\resources\views/member/dashboard.blade.php ENDPATH**/ ?>