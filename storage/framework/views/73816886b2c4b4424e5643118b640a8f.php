    ...
    <div class="max-w-6xl mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('home')); ?>" class="text-gray-300 hover:text-white text-sm transition">Home</a></li>
                    <li><a href="<?php echo e(route('expeditions.index')); ?>" class="text-gray-300 hover:text-white text-sm transition">Expeditions</a></li>
                    <li><a href="<?php echo e(route('events.index')); ?>" class="text-gray-300 hover:text-white text-sm transition">Events</a></li>
                    <li><a href="<?php echo e(route('community.index')); ?>" class="text-gray-300 hover:text-white text-sm transition">Community</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('marketplace.index')); ?>" class="text-gray-300 hover:text-white text-sm transition">Marketplace</a></li>
                    <li><a href="<?php echo e(route('vendors.index')); ?>" class="text-gray-300 hover:text-white text-sm transition">Vendors</a></li>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between text-sm text-gray-300">
            <div>
                <p>&copy; <?php echo e(now()->year); ?> Alpine Club of Pakistan. All rights reserved.</p>
            </div>
...
<?php /**PATH D:\xampp\htdocs\alpine\resources\views/partials/footer.blade.php ENDPATH**/ ?>