...
<div class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto px-4 py-12">
        <div class="bg-white rounded-lg shadow p-8">
            <form method="POST" action="<?php echo e(route('community.store')); ?>" class="space-y-6">
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <label class="flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition
                            <?php if(old('post_type') === 'post' || !old('post_type')): ?> border-blue-600 bg-blue-50 <?php endif; ?>">
                            <input
                                type="radio"
                                name="post_type"
                                value="post"
                                <?php echo e(old('post_type') === 'post' || !old('post_type') ? 'checked' : ''); ?>
                        ...
                        <!-- Journal Option -->
                        <label class="flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition
                            <?php if(old('post_type') === 'journal'): ?> border-blue-600 bg-blue-50 <?php endif; ?>">
                            <input
                                type="radio"
                                name="post_type"
                                value="journal"
                                <?php echo e(old('post_type') === 'journal' ? 'checked' : ''); ?>
                        ...
                        <!-- Photo Option -->
                        <label class="flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition
                            <?php if(old('post_type') === 'photo'): ?> border-blue-600 bg-blue-50 <?php endif; ?>">
                            <input
                                type="radio"
                                name="post_type"
                                value="photo"
                                <?php echo e(old('post_type') === 'photo' ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input
                        ...
                        maxlength="100"
                        class="input <?php $__errorArgs = ['region'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        class="input <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex gap-4 pt-6 border-t border-gray-200">
                    ...
                    <a href="<?php echo e(route('community.index')); ?>" class="btn-secondary flex-1">
                        Cancel
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\K2\K2_App\resources\views/community/create.blade.php ENDPATH**/ ?>