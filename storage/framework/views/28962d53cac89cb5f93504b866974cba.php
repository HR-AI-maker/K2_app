...
<div class="mb-6" style="padding: 1.5rem; background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1;">
    <h1 style="font-size: 1.5rem; font-weight: 600; color: #5e5873; margin: 0 0 0.25rem;">Welcome, <?php echo e($user->first_name); ?>! 👋</h1>
    ...
    <div style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                ...
                <h3 style="font-size: 1.75rem; font-weight: 600; color: #5e5873; margin: 0.5rem 0;"><?php echo e(ucfirst($user->membership_tier)); ?></h3>
    ...
    <div style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                ...
                <h3 style="font-size: 1.75rem; font-weight: 600; color: #5e5873; margin: 0.5rem 0;"><?php echo e($stats['total_orders']); ?></h3>
                <a href="<?php echo e(route('orders.index')); ?>" style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.75rem; font-weight: 600; color: #7367f0; text-decoration: none;">
                    View Orders →
                </a>
            </div>
    ...
    <div style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem;">
        <div style="display: flex; align-items: center; justify-content: space-between;">
            <div>
                ...
                <h3 style="font-size: 1.75rem; font-weight: 600; color: #5e5873; margin: 0.5rem 0;"><?php echo e($stats['total_cart_items']); ?></h3>
                <a href="<?php echo e(route('cart.index')); ?>" style="display: inline-flex; align-items: center; gap: 0.25rem; font-size: 0.75rem; font-weight: 600; color: #7367f0; text-decoration: none;">
                    View Cart →
                </a>
            </div>
...
<div class="mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <!-- Expeditions -->
        <a href="<?php echo e(route('expeditions.index')); ?>" style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem; text-decoration: none; display: block; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 32px 0 rgba(34,41,47,0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 24px 0 rgba(34,41,47,0.1)';">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🗻</div>
        ...
        <!-- Community -->
        <a href="<?php echo e(route('community.index')); ?>" style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem; text-decoration: none; display: block; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 32px 0 rgba(34,41,47,0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 24px 0 rgba(34,41,47,0.1)';">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">👥</div>
        ...
        <!-- Vendors -->
        <a href="<?php echo e(route('vendors.index')); ?>" style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem; text-decoration: none; display: block; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 32px 0 rgba(34,41,47,0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 24px 0 rgba(34,41,47,0.1)';">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">🏢</div>
        ...
        <!-- Profile -->
        <a href="<?php echo e(route('profile.edit')); ?>" style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; padding: 1.5rem; text-decoration: none; display: block; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-4px)'; this.style.boxShadow='0 8px 32px 0 rgba(34,41,47,0.2)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 24px 0 rgba(34,41,47,0.1)';">
            <div style="font-size: 2.5rem; margin-bottom: 1rem;">👤</div>
...
<div style="background: white; border-radius: 0.5rem; box-shadow: 0 4px 24px 0 rgba(34,41,47,0.1); border: 1px solid #ebe9f1; margin-bottom: 1.5rem; overflow: hidden;">
    <div style="padding: 1.25rem 1.5rem; border-bottom: 1px solid #ebe9f1;">
        <h2 style="font-size: 1.125rem; font-weight: 600; color: #5e5873; margin: 0;">Your <?php echo e(ucfirst($user->membership_tier)); ?> Membership Includes</h2>
    </div>
...
<div style="background: rgba(255,159,67,0.12); border: 1px solid rgba(255,159,67,0.2); border-radius: 0.5rem; padding: 1.5rem; display: flex; gap: 1rem;">
    ...
    <div>
        ...
        <a href="<?php echo e(route('profile.membership')); ?>" style="display: inline-flex; align-items: center; gap: 0.5rem; background: linear-gradient(118deg, #7367f0, #9e95f5); color: white; padding: 0.5rem 1rem; border-radius: 0.375rem; font-weight: 500; font-size: 0.875rem; margin-top: 0.75rem; text-decoration: none;">
            ↻ Renew Membership
        </a>
    </div>
</div>
