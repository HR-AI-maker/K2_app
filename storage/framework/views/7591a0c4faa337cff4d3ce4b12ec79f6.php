...
<div class="mb-8">
    ...
    <h1 class="text-4xl font-bold text-gray-900">Create New Vendor</h1>
</div>

<div class="bg-white rounded-lg shadow p-8">
    <form method="POST" action="<?php echo e(route('admin.vendors.store')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                ...
                >
                    ...
                    <option value="guide" <?php echo e(old('business_type') === 'guide' ? 'selected' : ''); ?>>Guide</option>
                    <option value="transport" <?php echo e(old('business_type') === 'transport' ? 'selected' : ''); ?>>Transport</option>
                    <option value="lodging" <?php echo e(old('business_type') === 'lodging' ? 'selected' : ''); ?>>Lodging</option>
                    <option value="equipment" <?php echo e(old('business_type') === 'equipment' ? 'selected' : ''); ?>>Equipment</option>
                    <option value="other" <?php echo e(old('business_type') === 'other' ? 'selected' : ''); ?>>Other</option>
                </select>
            ...
            <div class="flex items-center">
                <label for="is_certified" class="flex items-center">
                    <input
                        ...
                        name="is_certified"
                        value="1"
                        <?php echo e(old('is_certified') ? 'checked' : ''); ?>
...
unset($__errorArgs, $__bag); ?>"
            ><?php echo e(old('certification_details')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="<?php echo e(route('admin.vendors.index')); ?>" class="btn-secondary flex-1">
                Cancel
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\Desktop\K2\K2_App\resources\views/admin/vendors/create.blade.php ENDPATH**/ ?>