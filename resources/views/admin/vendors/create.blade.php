...
<div class="bg-white rounded-lg shadow p-8">
    <form method="POST" action="{{ route('admin.vendors.store') }}" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                >
                    ...
                    <option value="guide" {{ old('business_type') === 'guide' ? 'selected' : '' }}>Guide</option>
                    <option value="transport" {{ old('business_type') === 'transport' ? 'selected' : '' }}>Transport</option>
                    <option value="lodging" {{ old('business_type') === 'lodging' ? 'selected' : '' }}>Lodging</option>
                    <option value="equipment" {{ old('business_type') === 'equipment' ? 'selected' : '' }}>Equipment</option>
        ...
        <div>
            ...
            >{{ old('certification_details') }}</textarea>
        ...
        <div class="flex gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="{{ route('admin.vendors.index') }}" class="btn-secondary flex-1">
                Cancel
            </a>
        </div>
    </form>
