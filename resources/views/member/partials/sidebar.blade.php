<aside class="admin-sidebar" x-data="{
    openMenus: {
        account: {{ request()->routeIs('profile.*') ? 'true' : 'false' }}
    }
}">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('marketplace.index') }}" class="sidebar-item {{ request()->routeIs('marketplace.*') ? 'active' : '' }}">
            <span class="sidebar-item-icon">
        ...
        <a href="{{ route('cart.index') }}" class="sidebar-item {{ request()->routeIs('cart.*') ? 'active' : '' }}">
            <span class="sidebar-item-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
            </span>
        ...
        <a href="{{ route('expeditions.index') }}" class="sidebar-item {{ request()->routeIs('expeditions.*') ? 'active' : '' }}">
            <span class="sidebar-item-icon">
        ...
        <div class="sidebar-menu">
            ...
            <div x-show="openMenus.account" x-collapse class="sidebar-submenu">
                <a href="{{ route('profile.edit') }}" class="sidebar-subitem {{ request()->routeIs('profile.edit') ? 'active' : '' }}">Profile</a>
                <a href="{{ route('profile.membership') }}" class="sidebar-subitem {{ request()->routeIs('profile.membership') ? 'active' : '' }}">Membership</a>
                <a href="{{ route('profile.documents') }}" class="sidebar-subitem {{ request()->routeIs('profile.documents') ? 'active' : '' }}">Documents</a>
                <a href="{{ route('profile.medical') }}" class="sidebar-subitem {{ request()->routeIs('profile.medical') ? 'active' : '' }}">Medical</a>
                <a href="{{ route('profile.badges') }}" class="sidebar-subitem {{ request()->routeIs('profile.badges') ? 'active' : '' }}">Badges</a>
            </div>
        </div>
    </nav>
