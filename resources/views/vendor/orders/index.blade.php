                    ...
                    <tbody>
                        @foreach($orders as $order)
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                <td class="px-6 py-4">
                                    <a href="{{ route('vendor.orders.show', $order) }}" class="font-semibold text-blue-600 hover:text-blue-800">
                                        {{ $order->order_number }}
                                    </a>
                                </td>
                                ...
                                <td class="px-6 py-4 text-right font-semibold text-gray-900">
                                    Rs. {{ number_format($order->items->sum('total_price'), 0) }}
                                </td>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="{{ route('vendor.orders.show', $order) }}" class="text-blue-600 hover:text-blue-800">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
