<aside class="admin-sidebar" x-data="{
    openMenus: {
        products: {{ request()->routeIs('vendor.products.*') ? 'true' : 'false' }},
        orders: {{ request()->routeIs('vendor.orders.*') ? 'true' : 'false' }}
    }
}">
    <div class="sidebar-brand">
        <a href="{{ route('vendor.dashboard') }}" class="sidebar-brand-link">
    ...
    <nav class="sidebar-nav">
        <a href="{{ route('vendor.dashboard') }}" class="sidebar-item {{ request()->routeIs('vendor.dashboard') ? 'active' : '' }}">
        ...
        <div class="sidebar-menu">
            ...
            <div x-show="openMenus.products" x-collapse class="sidebar-submenu">
                <a href="{{ route('vendor.products.index') }}" class="sidebar-subitem {{ request()->routeIs('vendor.products.index') ? 'active' : '' }}">All Products</a>
                <a href="{{ route('vendor.products.create') }}" class="sidebar-subitem {{ request()->routeIs('vendor.products.create') ? 'active' : '' }}">Add Product</a>
            </div>
        </div>
        ...
        <div class="sidebar-menu">
            ...
            <div x-show="openMenus.orders" x-collapse class="sidebar-submenu">
                <a href="{{ route('vendor.orders.index') }}" class="sidebar-subitem {{ request()->routeIs('vendor.orders.index') ? 'active' : '' }}">All Orders</a>
            </div>
        </div>
    </nav>
